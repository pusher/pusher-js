/*!
 * Pusher JavaScript Library v1.6.3
 * http://pusherapp.com/
 *
...
WEB_SOCKET_SWF_LOCATION = "http://js.pusherapp.com/1.6.3/WebSocketMain.swf";
...
;(function() {
  var root = 'http://js.pusherapp.com/1.6.3';
  var deps = [],
      callback = function () {
        Pusher.ready()
      }
