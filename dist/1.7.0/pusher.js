/*!
 * Pusher JavaScript Library v1.7.0
 * http://pusherapp.com/
 *
...
WEB_SOCKET_SWF_LOCATION = "http://js.pusherapp.com/1.7.0/WebSocketMain.swf";
...
;(function() {
  var root = 'http://js.pusherapp.com/1.7.0';
  var deps = [],
      callback = function () {
        Pusher.ready()
      }
