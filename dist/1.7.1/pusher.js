/*!
 * Pusher JavaScript Library v1.7.1
 * http://pusherapp.com/
 *
...
WEB_SOCKET_SWF_LOCATION = "http://js.pusherapp.com/1.7.1/WebSocketMain.swf";
...
;(function() {
  var root = 'http://js.pusherapp.com/1.7.1';
  var deps = [],
      callback = function () {
        Pusher.ready()
      }
