...
/***/ function(module, exports, __webpack_require__) {
	...
	function Pusher(app_key, options) {
	    ...
	    var self = this;
	    this.key = app_key;
	    this.config = Util.extend(DefaultConfig.getGlobalConfig(), options.cluster ? DefaultConfig.getClusterConfig(options.cluster) : {}, options);
	    ...
	    this.connection = new ConnectionManager(this.key, Util.extend({ getStrategy: getStrategy,
