...
describe("DependencyLoader", function() {
  ...
  describe("#load", function() {
    ...
    it("should register a receiver", function() {
      loader.load("resource", {}, onLoaded);
      var receiver = scriptRequest.send.calls.argsFor(0)[0];
    ...
    it("should trigger all resource's callbacks", function() {
      ...
      var firstReceiver = firstScriptRequest.send.calls.argsFor(0)[0];
      ...
      var secondReceiver = scriptRequest.send.calls.argsFor(0)[0];
    ...
    describe("after loading the resource", function() {
      ...
      beforeEach(function() {
        loader.load("resource", {}, onLoaded);
        receiver = scriptRequest.send.calls.argsFor(0)[0];
        receiver.callback(null);
      });
      ...
      it("should not clean up the request when called back with true", function() {
        var loadCallback = onLoaded.calls.argsFor(0)[1];
