;(function() {
  ...
  Tests.addSuite('Pusher.Connection', {
    ...
    'Bug: impermanentlyClosing to connected': {
      'should not occur if: open state, get error, get conn_est': function(test) {
        Pusher.Transport = TestSocket;
      ...
      'should not occur if: open state, timeout on connected, close sock, get conn_est during close handshake': function(test) {
        Pusher.Transport = TestSocket;
        var connection = new Pusher.Connection('a');
